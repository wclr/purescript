...
-- --- ExternsDiff {edModuleName = ModuleName "A", edRefs = fromList [(ValueRef (Ident "foo"),Updated)]}

-- -- TypeVarInvisible t7 v t8
...
--                 { spanName = "tests/purs/make/A.purs"
--                 , spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}
--                 , spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 10}
--                 }
--             )
--             (ProperName {runProperName = "Foo"})
--             (Just [])
--         , ValueRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 10}}) (Ident "foo")
--         ]
--     , efImports = [ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Just (ModuleName "Prim")}, ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Nothing}]
--     , efFixities = []
--     , efTypeFixities = []
--     , efDeclarations =
--         [ EDType
--             { edTypeName = ProperName {runProperName = "Foo"}
--             , edTypeKind =
--                 ForAll
--                     ( SourceSpan
--                         { spanName = ""
...
--                     "k"
--                     (Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))))
--                     (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) "k")) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 14}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))))
--                     Nothing
--             , edTypeDeclarationKind = TypeSynonym
--             }
--         , EDTypeSynonym {edTypeSynonymName = ProperName {runProperName = "Foo"}, edTypeSynonymArguments = [("a", Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) "k"))], edTypeSynonymType = TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 14}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Int"}))}
--         , EDValue
--             { edValueName = Ident "foo"
--             , edValueType =
--                 ForAll
--                     ( SourceSpan
--                         { spanName = "tests/purs/make/A.purs"
--                         , spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 8}
--                         , spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}
--                         }
--                     , []
--                     )
--                     TypeVarInvisible
--                     "t7"
--                     (Just (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 28}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))))
--                     (ForAll (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) TypeVarInvisible "a" (Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) "t7")) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 22}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 24}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 21}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Int"})))) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 14}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Int"})))) (Just (SkolemScope {runSkolemScope = 0})))
--                     Nothing
--             }
--         ]
--     , efSourceSpan = SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 10}}
--     }

-- ExternsFile
--     { efVersion = "0.15.15"
--     , efModuleName = ModuleName "A"
--     , efExports = [TypeRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 6}}) (ProperName {runProperName = "Foo"}) (Just []), ValueRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 6}}) (Ident "foo"), ValueRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 6}}) (Ident "x")]
--     , efImports =
--         [ ExternsImport
--             { eiModule = ModuleName "Prim"
--             , eiImportType = Implicit
...
--                     (Just (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 28}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))))
--                     ( ForAll
--                         (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, [])
--                         TypeVarInvisible
--                         "a"
--                         ( Just
--                             ( TypeVar
--                                 ( SourceSpan
--                                     { spanName = "tests/purs/make/A.purs"
--                                     , spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}
--                                     , spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}
--                                     }
--                                 , []
--                                 )
...
--                             )
--                         )
--                         (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 22}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 24}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 21}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Int"})))) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 14}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Int"}))))
--                         (Just (SkolemScope {runSkolemScope = 0}))
--                     )
--                     Nothing
--             }
--         , EDValue {edValueName = Ident "x", edValueType = TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Int"}))}
--         ]
--     , efSourceSpan = SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 6}}
--     }
...
--     , efExports =
--         [ TypeRef
--             (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 12}})
--             (ProperName {runProperName = "Foo"})
--             (Just [ProperName {runProperName = "Foo"}])
--         , ValueRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 12}}) (Ident "foo")
--         ]
--     , efImports = [ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Just (ModuleName "Prim")}, ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Nothing}]
--     , efFixities = []
--     , efTypeFixities = []
...
--             { edTypeName =
--                 ProperName {runProperName = "Foo"}
--             , edTypeKind = ForAll (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) TypeVarInvisible "k" (Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) "k")) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) Nothing
--             , edTypeDeclarationKind =
--                 DataType
--                     Data
--                     [
--                         ( "a"
--                         , Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) "k")
--                         , Phantom
--                         )
--                     ]
--                     [(ProperName {runProperName = "Foo"}, [])]
--             }
--         , EDDataConstructor {edDataCtorName = ProperName {runProperName = "Foo"}, edDataCtorOrigin = Data, edDataCtorTypeCtor = ProperName {runProperName = "Foo"}, edDataCtorType = ForAll (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) TypeVarInvisible "k" (Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (ForAll (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) TypeVarVisible "a" (Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) "k")) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (KindApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Foo"}))) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "k")) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "a")) Nothing) Nothing, edDataCtorFields = []}
--         , EDValue
--             { edValueName = Ident "foo"
--             , edValueType =
--                 ForAll
...
--                                 { spanName = "tests/purs/make/A.purs"
--                                 , spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}
--                                 , spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 28}
--                                 }
--                             , []
--                             )
--                             (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))
...
--                                     { spanName = "tests/purs/make/A.purs"
--                                     , spanStart =
--                                         SourcePos {sourcePosLine = 3, sourcePosColumn = 25}
--                                     , spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}
--                                     }
--                                 , []
--                                 )
...
--                         )
--                         ( TypeApp
--                             (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, [])
--                             (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 22}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 24}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 21}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Int"}))))
--                             ( TypeApp
--                                 ( SourceSpan
--                                     { spanName =
--                                         "tests/purs/make/A.purs"
...
--                                 )
--                                 ( KindApp
--                                     (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, [])
--                                     ( TypeConstructor
--                                         ( SourceSpan
--                                             { spanName = "tests/purs/make/A.purs"
--                                             , spanStart =
...
--                                         , []
--                                         )
--                                         (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Foo"}))
--                                     )
--                                     ( TypeVar
--                                         (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, [])
--                                         "t7"
--                                     )
--                                 )
--                                 (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 29}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) "a")
--                             )
--                         )
--                         (Just (SkolemScope {runSkolemScope = 0}))
--                     )
...
--             }
--         ]
--     , efSourceSpan = SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 12}}
--     }

-- --- module A where\nfoo = 0\
-- -- Spans in efDeclarations are empty.

-- ExternsFile
--     { efVersion = "0.15.15"
--     , efModuleName = ModuleName "A"
--     , efExports = [ValueRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 8}}) (Ident "foo")]
--     , efImports = [ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Just (ModuleName "Prim")}, ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Nothing}]
--     , efFixities = []
--     , efTypeFixities = []
--     , efDeclarations =
...
--             }
--         ]
--     , efSourceSpan = SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 8}}
--     }
...
--             { spanName = "tests/purs/make/A.purs"
--             , spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}
--             , spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 8}
--             }
--     }
...
--     , efModuleName = ModuleName "A"
--     , efExports =
--         [TypeRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 12}}) (ProperName {runProperName = "Foo"}) (Just [ProperName {runProperName = "Foo"}]), ValueRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 12}}) (Ident "foo")]
--     , efImports = [ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Just (ModuleName "Prim")}, ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Nothing}]
--     , efFixities = []
--     , efTypeFixities = []
--     , efDeclarations =
...
--             { edTypeName = ProperName {runProperName = "Foo"}
--             , edTypeKind = ForAll (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) TypeVarInvisible "k" (Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) "k")) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) Nothing
--             , edTypeDeclarationKind = DataType Data [("a", Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) "k"), Phantom)] [(ProperName {runProperName = "Foo"}, [])]
--             }
--         , EDDataConstructor {edDataCtorName = ProperName {runProperName = "Foo"}, edDataCtorOrigin = Data, edDataCtorTypeCtor = ProperName {runProperName = "Foo"}, edDataCtorType = ForAll (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) TypeVarInvisible "k" (Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (ForAll (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) TypeVarVisible "a" (Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) "k")) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (KindApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Foo"}))) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "k")) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "a")) Nothing) Nothing, edDataCtorFields = []}
--         , EDValue
--             { edValueName = Ident "foo"
...
--                         TypeVarInvisible
--                         "a"
--                         (Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) "t7"))
--                         (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 22}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 24}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 21}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Int"})))) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (KindApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 28}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Foo"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) "t7")) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 29}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) "a")))
--                         (Just (SkolemScope {runSkolemScope = 0}))
--                     )
--                     Nothing
--             }
...
--     { efVersion = "0.15.15"
--     , efModuleName = ModuleName "A"
--     , efExports = [TypeRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 12}}) (ProperName {runProperName = "Foo"}) (Just [ProperName {runProperName = "Foo"}]), ValueRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 12}}) (Ident "foo")]
--     , efImports = [ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Just (ModuleName "Prim")}, ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Nothing}]
--     , efFixities = []
--     , efTypeFixities = []
--     , efDeclarations =
--         [ EDType
--             { edTypeName = ProperName {runProperName = "Foo"}
--             , edTypeKind = ForAll (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 17}}, []) TypeVarInvisible "k" (Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 17}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 17}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 17}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 17}}, []) "k")) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) Nothing
--             , edTypeDeclarationKind = DataType Data [("a", Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 17}}, []) "k"), Phantom)] [(ProperName {runProperName = "Foo"}, [])]
--             }
--         , EDDataConstructor {edDataCtorName = ProperName {runProperName = "Foo"}, edDataCtorOrigin = Data, edDataCtorTypeCtor = ProperName {runProperName = "Foo"}, edDataCtorType = ForAll (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) TypeVarInvisible "k" (Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (ForAll (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) TypeVarVisible "a" (Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 17}}, []) "k")) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (KindApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Foo"}))) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "k")) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "a")) Nothing) Nothing, edDataCtorFields = []}
--         , EDValue
--             { edValueName = Ident "foo"
--             , edValueType =
--                 ForAll
--                     ( SourceSpan
--                         { spanName = "tests/purs/make/A.purs"
--                         , spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 8}
--                         , spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 30}
--                         }
--                     , []
--                     )
--                     TypeVarInvisible
--                     "t7"
--                     (Just (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 28}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))))
--                     (ForAll (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 30}}, []) TypeVarInvisible "a" (Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 30}}, []) "t7")) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 30}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 30}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 22}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 24}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 21}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Int"})))) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 30}}, []) (KindApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 30}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 28}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Foo"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 30}}, []) "t7")) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 29}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 30}}, []) "a"))) (Just (SkolemScope {runSkolemScope = 0})))
--                     Nothing
--             }
--         ]
--     , efSourceSpan = SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 12}}
--     }
...
--                 DataType
--                     Data
--                     [("a", Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) "k"), Phantom)]
--                     [(ProperName {runProperName = "Foo"}, [])]
--             }
--         , EDDataConstructor
--             { edDataCtorName =
--                 ProperName {runProperName = "Foo"}
--             , edDataCtorOrigin = Data
--             , edDataCtorTypeCtor = ProperName {runProperName = "Foo"}
--             , edDataCtorType =
--                 ForAll
--                     ( SourceSpan
--                         { spanName = ""
...
--                         "a"
--                         (Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) "k"))
--                         (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (KindApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Foo"}))) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "k")) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "a"))
--                         Nothing
--                     )
--                     Nothing
--             , edDataCtorFields = []
--             }
--         , EDValue {edValueName = Ident "foo", edValueType = ForAll (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) TypeVarInvisible "t7" (Just (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 28}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (ForAll (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) TypeVarInvisible "a" (Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) "t7")) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 22}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 24}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 21}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Int"})))) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (KindApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 28}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Foo"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) "t7")) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 29}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) "a"))) (Just (SkolemScope {runSkolemScope = 0}))) Nothing}
--         ]
--     , efSourceSpan = SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 12}}
--     }
...
--     { efVersion = "0.15.15"
--     , efModuleName = ModuleName "A"
--     , efExports = [TypeRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 6}}) (ProperName {runProperName = "Foo"}) (Just [ProperName {runProperName = "Foo"}]), ValueRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 6}}) (Ident "foo"), ValueRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 6}}) (Ident "x")]
--     , efImports = [ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Just (ModuleName "Prim")}, ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Nothing}]
--     , efFixities = []
--     , efTypeFixities = []
--     , efDeclarations =
...
--                     "k"
--                     (Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))))
--                     (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 17}}, []) "k")) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))))
--                     Nothing
--             , edTypeDeclarationKind =
--                 DataType
--                     Data
...
--             }
--         , EDDataConstructor
--             { edDataCtorName = ProperName {runProperName = "Foo"}
--             , edDataCtorOrigin = Data
--             , edDataCtorTypeCtor = ProperName {runProperName = "Foo"}
--             , edDataCtorType =
--                 ForAll
...
--                         ( TypeApp
--                             (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, [])
--                             (KindApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Foo"}))) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "k"))
--                             (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "x")
--                         )
--                         Nothing
--                     )
--                     Nothing
...
--                     "t8"
--                     (Just (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 28}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))))
--                     (ForAll (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) TypeVarInvisible "y" (Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) "t8")) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 22}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 24}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 18}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 21}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Int"})))) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (KindApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 28}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Foo"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) "t8")) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 29}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) "y"))) (Just (SkolemScope {runSkolemScope = 0})))
--                     Nothing
--             }
--         , EDValue {edValueName = Ident "x", edValueType = TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Int"}))}
--         ]
...
--                                     ( SourceSpan
--                                         { spanName = "tests/purs/make/A.purs"
--                                         , spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 22}
--                                         , spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 24}
--                                         }
--                                     , []
--                                     )
--                                     ( Qualified
...
--                                 ( SourceSpan
--                                     { spanName = "tests/purs/make/A.purs"
--                                     , spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 20}
--                                     , spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}
--                                     }
--                                 , []
--                                 )
--                                 (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 20}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 22}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 24}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 20}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 21}}, []) "b"))
--                                 (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (KindApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 28}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Foo"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 25}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) "t8")) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 29}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 30}}, []) "a"))
--                             )
--                             (Just (SkolemScope {runSkolemScope = 0}))
--                         )
...
-- -- data Baz a b = Foo a | Bar b\n

-- ExternsFile
--     { efVersion = "0.15.15"
--     , efModuleName = ModuleName "A"
--     , efExports = [TypeRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}) (ProperName {runProperName = "Baz"}) (Just [ProperName {runProperName = "Foo"}, ProperName {runProperName = "Bar"}])]
--     , efImports = [ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Just (ModuleName "Prim")}, ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Nothing}]
--     , efFixities = []
--     , efTypeFixities = []
--     , efDeclarations =
--         [ EDType
--             { edTypeName =
--                 ProperName {runProperName = "Baz"}
--             , edTypeKind = TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))))
--             , edTypeDeclarationKind =
--                 DataType
--                     Data
--                     [ ("a", Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))), Representational)
--                     , ("b", Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))), Representational)
--                     ]
--                     [(ProperName {runProperName = "Foo"}, [TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 20}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 21}}, []) "a"]), (ProperName {runProperName = "Bar"}, [TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 28}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) "b"])]
--             }
--         , EDDataConstructor
--             { edDataCtorName =
--                 ProperName
...
--                     }
--             , edDataCtorOrigin = Data
--             , edDataCtorTypeCtor = ProperName {runProperName = "Baz"}
--             , edDataCtorType =
--                 ForAll
--                     ( SourceSpan
--                         { spanName = ""
...
--                                 (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"})))
--                                 ( TypeVar
--                                     (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 20}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 21}}, [])
--                                     "a"
--                                 )
--                             )
--                             (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Baz"}))) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "a")) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "b"))
--                         )
--                         Nothing
--                     )
--                     Nothing
--             , edDataCtorFields = [Ident "value0"]
--             }
--         , EDDataConstructor {edDataCtorName = ProperName {runProperName = "Bar"}, edDataCtorOrigin = Data, edDataCtorTypeCtor = ProperName {runProperName = "Baz"}, edDataCtorType = ForAll (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) TypeVarVisible "a" (Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (ForAll (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) TypeVarVisible "b" (Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 28}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) "b")) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Baz"}))) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "a")) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "b"))) Nothing) Nothing, edDataCtorFields = [Ident "value0"]}
--         ]
--     , efSourceSpan = SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}
--     }

-- -- changed order a <-> b: data Baz b a = Foo a | Bar b\n
...
--     , efDeclarations =
--         [ EDType
--             { edTypeName = ProperName {runProperName = "Baz"}
--             , edTypeKind = TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))))
--             , edTypeDeclarationKind =
--                 DataType
--                     Data
...
--                         )
--                     ,
--                         ( ProperName {runProperName = "Bar"}
--                         ,
--                             [ TypeVar
--                                 (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 28}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, [])
--                                 "b"
--                             ]
--                         )
--                     ]
...
--                             , []
--                             )
--                             (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 20}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 21}}, []) "a"))
--                             ( TypeApp
--                                 (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, [])
--                                 ( TypeApp
--                                     (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, [])
...
--                                         , []
--                                         )
--                                         (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Baz"}))
--                                     )
--                                     ( TypeVar
--                                         ( SourceSpan
--                                             { spanName = ""
...
--                                     )
--                                 )
--                                 (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "a")
--                             )
--                         )
--                         Nothing
--                     )
...
--             }
--         , EDDataConstructor
--             { edDataCtorName = ProperName {runProperName = "Bar"}
--             , edDataCtorOrigin = Data
--             , edDataCtorTypeCtor = ProperName {runProperName = "Baz"}
--             , edDataCtorType =
--                 ForAll
...
--                         "a"
--                         (Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))))
--                         (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 28}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 29}}, []) "b")) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Baz"}))) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "b")) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "a")))
--                         Nothing
--                     )
--                     Nothing
--             , edDataCtorFields = [Ident "value0"]
...
--     { efVersion = "0.15.15"
--     , efModuleName = ModuleName "A"
--     , efExports = [TypeClassRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 16}}) (ProperName {runProperName = "Eq"}), TypeRef (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 16}}) (ProperName {runProperName = "Baz"}) (Just [ProperName {runProperName = "Foo"}, ProperName {runProperName = "Bar"}]), TypeInstanceRef (SourceSpan {spanName = "<generated>", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}) (Ident "eqBaz") CompilerNamed]
--     , efImports = [ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Just (ModuleName "Prim")}, ExternsImport {eiModule = ModuleName "Prim", eiImportType = Implicit, eiImportedAs = Nothing}]
--     , efFixities = []
--     , efTypeFixities = []
--     , efDeclarations =
--         [ EDType {edTypeName = ProperName {runProperName = "Eq"}, edTypeKind = ForAll (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) TypeVarInvisible "k" (Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 11}}, []) "k")) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Constraint"})))) Nothing, edTypeDeclarationKind = ExternData [Nominal]}
--         , EDType {edTypeName = ProperName {runProperName = "Eq$Dict"}, edTypeKind = ForAll (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 11}}, []) TypeVarInvisible "k" (Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 11}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 11}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 11}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 11}}, []) "k")) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) Nothing, edTypeDeclarationKind = DataType Newtype [("a", Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 11}}, []) "k"), Phantom)] [(ProperName {runProperName = "Eq$Dict"}, [TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Record"}))) (KindApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (REmpty (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, [])) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))))])]}
--         , EDDataConstructor {edDataCtorName = ProperName {runProperName = "Eq$Dict"}, edDataCtorOrigin = Newtype, edDataCtorTypeCtor = ProperName {runProperName = "Eq$Dict"}, edDataCtorType = ForAll (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) TypeVarInvisible "k" (Just (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))) (ForAll (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) TypeVarVisible "a" (Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 11}}, []) "k")) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Record"}))) (KindApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (REmpty (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, [])) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})))))) (TypeApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (KindApp (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Eq$Dict"}))) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "k")) (TypeVar (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) "a"))) Nothing) Nothing, edDataCtorFields = [Ident "dict"]}
--         , EDClass {edClassName = ProperName {runProperName = "Eq"}, edClassTypeArguments = [("a", Just (TypeVar (SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos {sourcePosLine = 2, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 2, sourcePosColumn = 11}}, []) "k"))], edClassMembers = [], edClassConstraints = [], edFunctionalDependencies = [], edIsEmpty = True}
--         , EDType {edTypeName = ProperName {runProperName = "Baz"}, edTypeKind = TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"})), edTypeDeclarationKind = DataType Data [] [(ProperName {runProperName = "Foo"}, []), (ProperName {runProperName = "Bar"}, [])]}
--         , EDDataConstructor {edDataCtorName = ProperName {runProperName = "Foo"}, edDataCtorOrigin = Data, edDataCtorTypeCtor = ProperName {runProperName = "Baz"}, edDataCtorType = TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Baz"})), edDataCtorFields = []}
--         , EDDataConstructor {edDataCtorName = ProperName {runProperName = "Bar"}, edDataCtorOrigin = Data, edDataCtorTypeCtor = ProperName {runProperName = "Baz"}, edDataCtorType = TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "A")) (ProperName {runProperName = "Baz"})), edDataCtorFields = []}
--         , EDInstance
--             { edInstanceClassName =
--                 Qualified
--                     (ByModuleName (ModuleName "A"))
...
--                         }
--                     )
--             , edInstanceName = Ident "eqBaz"
--             , edInstanceForAll = []
--             , edInstanceKinds =
--                 [ TypeConstructor
--                     ( SourceSpan
--                         { spanName = "tests/purs/make/A.purs"
--                         , spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 13}
--                         , spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 16}
--                         }
--                     , []
--                     )
--                     (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Type"}))
...
--                 Just
--                     ( ChainId
--                         ("tests/purs/make/A.purs", SourcePos {sourcePosLine = 4, sourcePosColumn = 1})
--                     )
--             , edInstanceChainIndex = 0
--             , edInstanceNameSource = UserNamed
...
--             }
--         ]
--     , efSourceSpan = SourceSpan {spanName = "tests/purs/make/A.purs", spanStart = SourcePos

--             {sourcePosLine = 1, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 16}}
--     }
...
multipleErrors0 =
    MultipleErrors
        { runMultipleErrors =
            [ ErrorMessage
                [ErrorInModule (ModuleName "Main"), PositionedError (SourceSpan {spanName = "tests/purs/warning/UnusedExplicitImportTypeOp.purs", spanStart = SourcePos {sourcePosLine = 6, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 6, sourcePosColumn = 30}} :| [])]
                ( UnusedExplicitImport
                    (ModuleName "Lib")
                    [ TyOpName (OpName {runOpName = "~>"})
                    ]
                    Nothing
                    [ValueRef (SourceSpan {spanName = "tests/purs/warning/UnusedExplicitImportTypeOp.purs", spanStart = SourcePos {sourcePosLine = 6, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 6, sourcePosColumn = 30}}) (Ident "natId")]
                )
            , ErrorMessage
                [ ErrorInModule (ModuleName "Main")
                , PositionedError
                    ( SourceSpan
                        { spanName = "tests/purs/warning/UnusedExplicitImportTypeOp.purs"
                        , spanStart = SourcePos {sourcePosLine = 6, sourcePosColumn = 1}
                        , spanEnd = SourcePos {sourcePosLine = 6, sourcePosColumn = 30}
                        }
                        :| []
                    )
                ]
        ...
        { runMultipleErrors =
            [ ErrorMessage
                ...
                ( UnusedExplicitImport
                    ...
                    Nothing
                    [ ValueRef
                        (SourceSpan {spanName = "tests/purs/warning/UnusedExplicitImportTypeOp.purs", spanStart = SourcePos {sourcePosLine = 6, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 6, sourcePosColumn = 30}})
                        (Ident "natId")
                    ]
                )
            ]
    ...
    [
        (
            (
                (
                    ( SourceSpan
                        { spanName = "tests/purs/make/Module.purs"
                        , spanStart =
                            SourcePos
                                { sourcePosLine = 3
                                , sourcePosColumn = 1
            ...
            ,
                ( TypedValue
                    ...
                    ( Abs
                        ( VarBinder
                            (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 27}})
                            (Ident "xxx")
                        )
                        ( TypedValue
                            True
                            ( PositionedValue
                                (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 11}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 14}})
                                []
                                ( Let
                                    FromWhere
                                    [ ValueDeclaration
                                        ( ValueDeclarationData
                                            { valdeclSourceAnn = (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 5, sourcePosColumn = 9}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 27}}, [])
                                            , valdeclIdent = Ident "yyy"
                                            , valdeclName = Public
                                            , valdeclBinders = []
                                            , valdeclExpression =
                                                [ GuardedExpr
                                                    []
                                                    ( PositionedValue
                                                        (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 5, sourcePosColumn = 15}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 27}})
                                                        []
                                                        ( Literal
                                                            (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 5, sourcePosColumn = 15}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 27}})
                                                            (StringLiteral "xxx_string")
                                                        )
                                                    )
                                                ]
                                            }
                                    ...
                                    ( TypedValue
                                        ...
                                        ( PositionedValue
                                            ( SourceSpan
                                                { spanName = "tests/purs/make/Module.purs"
                                                , spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 11}
                                                , spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 14}
                                                }
                                            )
                                            []
                                            ( Var
                                                ...
                                                (Qualified (BySourcePos (SourcePos {sourcePosLine = 5, sourcePosColumn = 9})) (Ident "yyy"))
                                            )
                                        )
                                        ( TypeConstructor
                                            ( SourceSpan
                            ...
                            (TypeConstructor (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 15}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 21}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "String"})))
                        )
                    )
                    ( TypeApp
                        ( SourceSpan
                        ...
                        ( TypeApp
                            (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 21}}, [])
                            (TypeConstructor (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 12}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 14}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"})))
                            ( TypeConstructor
                                (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 11}}, [])
                                ( Qualified
                                    (ByModuleName (ModuleName "Prim"))
                                    ( ProperName
                                        { runProperName = "Int"
                ...
                , TypeApp (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 21}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 21}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 12}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 14}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 11}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Int"})))) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 3, sourcePosColumn = 15}, spanEnd = SourcePos {sourcePosLine = 3, sourcePosColumn = 21}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "String"})))
                )
            )
        , []
        )
...
inferredExp =
    TypedValue
        ...
        ( Abs
            ( VarBinder
                (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 5, sourcePosColumn = 1}, spanEnd = SourcePos {sourcePosLine = 8, sourcePosColumn = 14}})
                (Ident "arg1")
            )
            ( TypedValue
                True
                ( Abs
                    ( VarBinder
                        ( SourceSpan
                            ...
                            , spanEnd = SourcePos {sourcePosLine = 8, sourcePosColumn = 14}
                            }
                        )
                        (Ident "agr2")
                    )
                    ( TypedValue
                        True
                        ( PositionedValue
                            (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 5, sourcePosColumn = 17}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 20}})
                            []
                            ( Let
                                FromWhere
                                [ ValueDeclaration
                                    ( ValueDeclarationData
                                        { valdeclSourceAnn = (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 7, sourcePosColumn = 3}, spanEnd = SourcePos {sourcePosLine = 7, sourcePosColumn = 21}}, [])
                                        , valdeclIdent = Ident "yyy"
                                        , valdeclName = Public
                                        , valdeclBinders = []
                                        , valdeclExpression = [GuardedExpr [] (PositionedValue (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 7, sourcePosColumn = 9}, spanEnd = SourcePos {sourcePosLine = 7, sourcePosColumn = 21}}) [] (Literal (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 7, sourcePosColumn = 9}, spanEnd = SourcePos {sourcePosLine = 7, sourcePosColumn = 21}}) (StringLiteral "xxx_string")))]
                                        }
                                    )
                                , ValueDeclaration
                                    ( ValueDeclarationData
                                        { valdeclSourceAnn = (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 8, sourcePosColumn = 3}, spanEnd = SourcePos {sourcePosLine = 8, sourcePosColumn = 14}}, [])
                                        , valdeclIdent = Ident "zzz"
                                        , valdeclName = Public
                                        , valdeclBinders = []
                                        , valdeclExpression =
                                            [ GuardedExpr
                                                []
                                                ( Abs
                                                    (VarBinder (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 8, sourcePosColumn = 3}, spanEnd = SourcePos {sourcePosLine = 8, sourcePosColumn = 14}}) (GenIdent Nothing 0))
                                                    ( TypedValue
                                                        True
                                                        ( PositionedValue
                                                            (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 8, sourcePosColumn = 11}, spanEnd = SourcePos {sourcePosLine = 8, sourcePosColumn = 14}})
                                                            []
                                                            ( Var
                                                                (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 8, sourcePosColumn = 11}, spanEnd = SourcePos {sourcePosLine = 8, sourcePosColumn = 14}})
                                                                ( Qualified
                                                                    (BySourcePos (SourcePos {sourcePosLine = 7, sourcePosColumn = 3}))
                                                                    (Ident "yyy")
                                                                )
                                                            )
                                                        )
                                ...
                                ( TypedValue
                                    True
                                    (PositionedValue (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 5, sourcePosColumn = 17}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 20}}) [] (Var (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 5, sourcePosColumn = 17}, spanEnd = SourcePos {sourcePosLine = 5, sourcePosColumn = 20}}) (Qualified (BySourcePos (SourcePos {sourcePosLine = 7, sourcePosColumn = 3})) (Ident "yyy"))))
                                    ( TypeConstructor
                                        (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 27}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 33}}, [])
                                        ( Qualified
                                            (ByModuleName (ModuleName "Prim"))
                                            (ProperName {runProperName = "String"})
                                        )
                        ...
                        (TypeConstructor (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 27}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 33}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "String"})))
                    )
                )
                ( TypeApp
                    ( SourceSpan
                        { spanName = "tests/purs/make/Module.purs"
                        , spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 16}
                        , spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 33}
                        }
                    , []
                    )
                    ( TypeApp
                        ...
                        ( TypeConstructor
                            ( SourceSpan
                                { spanName = "tests/purs/make/Module.purs"
                                , spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 24}
                                , spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 26}
                                }
                            , []
                            )
                        ...
                        ( TypeConstructor
                            ( SourceSpan
                                { spanName = "tests/purs/make/Module.purs"
                                , spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 16}
                                , spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 23}
                                }
                            , []
                            )
                            (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Boolean"}))
                        )
                    )
                    (TypeConstructor (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 27}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 33}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "String"})))
                )
        ...
        (TypeApp (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 33}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 33}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 13}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 15}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 12}}, []) (Qualified (ByModuleName (ModuleName "Module")) (ProperName {runProperName = "Some"})))) (TypeApp (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 16}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 33}}, []) (TypeApp (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 16}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 33}}, []) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 24}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 26}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"}))) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 16}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 23}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Boolean"})))) (TypeConstructor (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 27}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 33}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "String"})))))

checkEnvNames :: [(Qualified Ident, (Type (SourceSpan, [a]), NameKind, NameVisibility))]
checkEnvNames =
    [
        ( Qualified (ByModuleName (ModuleName "Module")) (Ident "bar")
        ,
            ( TypeApp
                ( SourceSpan
                    { spanName = "tests/purs/make/Module.purs"
                    , spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 8}
                    , spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 22}
                    }
                , []
                )
                ( TypeApp
                    ...
                    (TypeConstructor (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 13}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 15}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Function"})))
                    ( TypeConstructor
                        (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 8}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 12}}, [])
                        ( Qualified
                            (ByModuleName (ModuleName "Module"))
                            (ProperName {runProperName = "Some"})
                        )
                    )
                )
                (TypeConstructor (SourceSpan {spanName = "tests/purs/make/Module.purs", spanStart = SourcePos {sourcePosLine = 4, sourcePosColumn = 16}, spanEnd = SourcePos {sourcePosLine = 4, sourcePosColumn = 22}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "String"})))
            , Public
            , Defined
            )
        )
    ,
        ( Qualified
            (ByModuleName (ModuleName "Module"))
            (Ident "foo")
        , (TypeConstructor (SourceSpan {spanName = "", spanStart = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}, spanEnd = SourcePos {sourcePosLine = 0, sourcePosColumn = 0}}, []) (Qualified (ByModuleName (ModuleName "Prim")) (ProperName {runProperName = "Int"})), Public, Defined)
        )
    ]
